                ...
                <div class="col">
                    <div class="single-product">
                        ...
                        <div class="product-name">
                            <a href="{{route('detail.index', $product_average_rating->slug)}}" title="Fusce aliquam">{{$product_average_rating->name}}</a>
                        </div>
                        <div class="price-rating">
                            <span class="old-price" style="color:red">{{$product_average_rating->price}}</span>
                            <span >{{$product_average_rating->price_sale}}</span>
                            <div class="ratings">
                                <span>{{$product_average_rating->average_rating}}</span> <i class="fa fa-star"></i>
