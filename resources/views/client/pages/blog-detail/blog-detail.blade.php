            ...
            $.ajax({
                ...
                success(resp) {
                    if (resp.success) {
                        ...
                        showMessage('Thêm bình luận thành công', '#4CAF50');
                    }
                },
                error(err) {
                    let msg = err.responseJSON?.message || 'Lỗi, thử lại';
                    showMessage('Thêm thất bại', '#dc3545');
                }
            });
        });
            ...
            $.ajax({
                ...
                success(resp) {
                    if (resp.success) {
                        $('#comment-' + id).remove();
                        $('#comment-count').text(resp.count + ' Bình Luận');
                        showMessage('Xóa bình luận thành công', '#4CAF50');
                    }
                },
                error() {
                    showMessage('Xóa thất bại', '#dc3545');
                }
            });
        });
    });
