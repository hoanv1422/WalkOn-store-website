            ...
            <div class="col-lg-6">
                <div class="single-product-img tab-content">
                    <div class="single-pro-main-image tab-pane active" id="pro-large-img-1">
                        <a href="#"><img class="optima_zoom" src="client_views/img/product/7.png" data-zoom-image="client_views/img/product/7.png" alt="optima"/></a>
                    </div>
                    <div class="single-pro-main-image tab-pane" id="pro-large-img-2">
                        <a href="#"><img class="optima_zoom" src="client_views/img/product/2.png" data-zoom-image="client_views/img/product/2.png" alt="optima"/></a>
                    </div>
                    <div class="single-pro-main-image tab-pane" id="pro-large-img-3">
                        <a href="#"><img class="optima_zoom" src="client_views/img/product/8.png" data-zoom-image="client_views/img/product/8.png" alt="optima"/></a>
                    </div>
                    <div class="single-pro-main-image tab-pane" id="pro-large-img-4">
                        <a href="#"><img class="optima_zoom" src="client_views/img/product/1.png" data-zoom-image="client_views/img/product/1.png" alt="optima"/></a>
                    </div>
                    <div class="single-pro-main-image tab-pane" id="pro-large-img-5">
                        <a href="#"><img class="optima_zoom" src="client_views/img/product/9.png" data-zoom-image="client_views/img/product/9.png" alt="optima"/></a>
                    </div>
                </div>
                <div class="nav product-page-slider">
                    <div class="single-product-slider">
                        <a class="active" href="#pro-large-img-1" data-bs-toggle="tab">
                            <img src="client_views/img/product/28.png" alt="">
                        </a>
                    </div>
                    <div class="single-product-slider">
                        <a href="#pro-large-img-2" data-bs-toggle="tab">
                            <img src="client_views/img/product/30.png" alt="">
                        </a>
                    </div>
                    <div class="single-product-slider">
                        <a href="#pro-large-img-3" data-bs-toggle="tab">
                            <img src="client_views/img/product/29.png" alt="">
                        </a>
                    </div>
                    <div class="single-product-slider">
                        <a href="#pro-large-img-4" data-bs-toggle="tab">
                            <img src="client_views/img/product/31.png" alt="">
                        </a>
                    </div>
                    <div class="single-product-slider">
            ...
            <div class="col-lg-6">
                <div class="single-product-details">
                    ...
                    <div class="single-product-info">
                        ...
                        <div class="share">
                            <img src="client_views/img/product/share.png" alt="">
                        </div>
                    </div>
                    <div class="action">
