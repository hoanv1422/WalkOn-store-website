                                        ...
                                        <div class="col-lg-6">
                                            <div class="checkout-collapse">
                                                ...
                                                <form action="#">
                                                    ...
                                                    <p>By creating an account you will be able to shop faster, be up to
                                                        date on an order's status, and keep track of the orders you have
                                                        previously made.</p>
                                                    <button type="submit" value="Continue"
                                                        class="check-button">Continue</button>
                                                </form>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="account-details">
                                                ...
                                                <div class="checkbox">
                                                    <input type="checkbox" name="newsletter">I wish to subscribe to
                                                    the Malias1 newsletter.
                                                </div>
                                                <div class="checkbox">
                                                    <input type="checkbox" checked="" name="shipping-address">My
                            ...
                            <div id="collapseFour" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <div class="delivery-method">
                                        ...
                                        <div class="radio">
                                            <input type="radio" checked="" value="shipping-method">Flat
                                            Shipping Rate - $5.00
                                        </div>
                            ...
                            <div id="collapseFive" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <div class="patment-method">
                                        ...
                                        <div class="radio">
                                            <input type="radio" checked="" value="shipping-method">Cash On
                                            Delivery
                                        </div>
                                        <p> <strong> Add Comments About Your Order</strong></p>
                                        <p>
                            ...
                            <div id="collapseSix" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <div class="confirm-order">
                                        ...
                                        <button type="submit" value="Continue" class="check-button">Confirm
                                            Order</button>
                                    </div>
                                </div>
                            </div>
