<div class="slider-area home2">
    <div class="bend niceties preview-2">
        <div id="nivoslider" class="slides">
            <img src="client_views/img/slider/slider-3.jpg" alt="" title="#slider-direction-1"  />
            <img src="client_views/img/slider/slider-4.jpg" alt="" title="#slider-direction-2"  />
        </div>
        <!-- direction 1 -->
        <div id="slider-direction-1" class="t-cn slider-direction">
            ...
            <div class="slider-content t-lfl s-tb slider-1">
                <div class="title-container s-tb-c title-compress">
                    <img src="client_views/img/slider/slider-logo.png" alt="">
