                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <p class="text-muted mb-0">
                                                            Màu sắc: <span class="fw-medium">{{ $item->variant_color_name ?? 'N/A' }}</span>
                                                        </p>
                                                        <p class="text-muted mb-0">
                                                            Kích cỡ: <span class="fw-medium">{{ $item->variant_size_name ?? 'N/A' }}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                    ...
                    <div class="card-body">
                        ...
                        <div class="profile-timeline">
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                ...
                                <!-- Thêm các bước khác vào timeline nếu cần -->
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-header">
                        <div class="d-flex">
                            <h5 class="card-title flex-grow-1 mb-0">
                                <i class="mdi mdi-truck-fast-outline align-middle me-1 text-muted"></i> Thông tin vận chuyển
                            </h5>
                            <div class="flex-shrink-0">
