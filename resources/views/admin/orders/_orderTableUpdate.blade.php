            ...
            <form action="" method="POST" class="tablelist-form" autocomplete="off">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="customername-field" name="customer_name" class="form-control"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="date-field" name="order_date" class="form-control"
                            data-provider="flatpickr" required data-date-format="d M, Y" data-enable-time
                    ...
                    <div class="row gy-4 mb-3">
                        <div class="col-md-6">
                            <div>
                                ...
                                <input type="text" id="amount-field" name="total_price" class="form-control"
                                    placeholder="Nhập tổng số tiền" readonly />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div>
                                <label for="payment-field" class="form-label">Phương thức thanh toán</label>
                                <select class="form-control" data-trigger name="payment_method" id="payment-field"
                                    readonly disabled>
