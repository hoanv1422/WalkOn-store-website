                ...
                <div class="card mt-n5">
                    <div class="card-body p-4">
                        <div class="text-center">
                            ...
                            <p class="text-muted mb-0"style="text-transform:capitalize"> {{ $admin->role }}</p>
                        </div>
                    </div>
                </div>
                <!--end card-->
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nameInput" name="name" placeholder="Nhập tên của bạn" value="{{ old('name', $admin->name) }}">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="phonenumberInput" name="phone" placeholder="Nhập số điện thoại" value="{{ old('name', $admin->phone) }}">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="emailInput" class="form-label">Địa chỉ</label>
                                            <input type="text" class="form-control" id="addressInput" name="address" placeholder="Nhập địa chỉ " value="{{ old('name', $admin->address) }}">
                                        </div>
                                    </div>
                                    <!--end col-->
